...
/* Used to serialize and deserialize LocalDate objects when communicating with the API.
...
fun dateDeserializer(date: String) : LocalDate = LocalDate.parse(date, API_DATE_FORMATTER)